...
<aside id="default-sidebar"
    ...
    aria-label="Sidebar">
    <div class="flex flex-col h-full px-3 py-4 overflow-y-auto bg-gradient-to-tl from-[#FFEB00] to-[#344CB7] text-white">
