    ...
    <tbody>
        @forelse($data as $key => $item)
            <tr>
                ...
                <td>{{ $item->nama }}</td>
                <td>{{ $item->email }}</td>
                <td>{{ $item->webinar->webinar ?? '-' }}</td>
                <td>{{ $item->webinar->tanggal ?? '-' }}</td>
                <td>{{ \Carbon\Carbon::parse($item->webinar->mulai)->format('H:i') ?? '-' }}</td>
                <td>{{ \Carbon\Carbon::parse($item->webinar->selesai)->format('H:i') ?? '-' }}</td>
            </tr>
                @empty
                <tr>
        ...
        <div class="footer-signatures">
            ...
            <div class="signature-row">
                <div class="signature-box">
                    ...
                    <div class="signature-position">Ketua Pelaksana Webinar</div>
                </div>

                <div class="signature-box">
                    <span class="signature-name"></span>
                    <div class="signature-position">Penyelenggara Webinar</div>
                </div>
