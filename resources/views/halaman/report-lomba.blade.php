...
<body>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-left">{{ $item->lomba->lomba ?? '-' }}</td>
            <td>{{ \Carbon\Carbon::parse($item->lomba->tanggal)->format('d-m-Y') ?? '-' }}</td>
    <td>{{ \Carbon\Carbon::parse($item->lomba->mulai)->format('H:i') ?? '-' }}</td>
    <td>{{ \Carbon\Carbon::parse($item->lomba->selesai)->format('H:i') ?? '-' }}</td>
        </tr>
        @empty
        <tr>
