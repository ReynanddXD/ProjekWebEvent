                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    @forelse ($semuaLomba as $lomba)
                        <div
                            ...
                            <a href="#">
                                <img class="w-full h-48 object-cover" src="{{ asset('storage/' . $lomba->gambar) }}"
                                    alt="Poster Lomba">
                            </a>
                            ...
                            <div class="p-6 flex-grow">
                                ...
                                <ul class="text-gray-700 text-sm list-disc list-inside space-y-1">
                                    ...
                                    <li><span class="font-semibold">Biaya:</span>

                                        @if ($lomba->harga > 0)

                                            Rp {{ number_format($lomba->harga, 0, ',', '.') }}
                                        @else
                                            Gratis
                                        @endif
                                    </li>
                                    ...
                                    <li><span class="font-semibold">Tanggal:</span>
                                        {{ \Carbon\Carbon::parse($lomba->pelaksanaan)->format('d F Y') }}</li>
                                    <li><span class="font-semibold">Deskripsi:</span> {{ Str::limit($lomba->deskripsi, 100) }}
                                    </li>
                                </ul>
                            </div>
